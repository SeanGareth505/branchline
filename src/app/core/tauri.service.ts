...
export class TauriService {
  ...
  private async mockInvoke<T>(cmd: string, args?: Record<string, unknown>): Promise<T> {
    ...
    const mocks: Record<string, unknown> = {
      ...
      get_git_identity: { name: 'Demo User', email: 'demo@example.com' },
      ...
      github_git_status: {
        ...
        accounts: [
          ...
          { login: 'teammate', active: false, ok: true },
        ],
      },
      ...
      list_host_repositories: [
        {
          ...
          htmlUrl: 'https://github.com/demo/navigo',
          private: false,
          provider: 'github',
        ...
        },
        {
          ...
          htmlUrl: 'https://github.com/demo/lumora',
          private: true,
          provider: 'github',
        ...
        },
        {
          id: 'github:3',
          name: 'branchline',
          fullName: 'demo/branchline',
          cloneUrl: 'https://github.com/demo/branchline.git',
          sshUrl: 'git@github.com:demo/branchline.git',
          htmlUrl: 'https://github.com/demo/branchline',
          private: false,
          provider: 'github',
      ...
      list_identity_contexts: {
        effective: { name: 'Demo User', email: 'demo@example.com' },
        effectiveScope: 'global',
        local: null,
        global: { name: 'Demo User', email: 'demo@example.com' },
        hasRepo: true,
        candidates: [
          {
            id: 'global:demo@example.com',
            name: 'Demo User',
          ...
          {
            id: 'history:demo@users.noreply.github.com',
            name: 'Demo User',
