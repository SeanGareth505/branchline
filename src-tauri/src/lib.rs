...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::repos::peek_repository,
            commands::repos::probe_repository,
            commands::repos::focus_repository,
            ...
            commands::hooks::list_repo_checks,
            commands::hooks::save_check_script,
            commands::hooks::delete_check_script,
            commands::hooks::set_check_enabled,
            commands::hooks::run_repo_check,
            ...
            commands::release::get_release_status,
            commands::release::get_release_setup_hints,
            commands::release::seed_release_version_file,
            commands::release::save_release_config,
            commands::release::preview_release,
            ...
            commands::submodules::list_lfs_files,
            commands::submodules::lfs_pull,
            commands::submodules::lfs_track,
            commands::submodules::lfs_untrack,
            commands::submodules::lfs_lock,
            ...
            commands::pull_requests::update_pull_request,
            ...
            commands::github_git::github_git_status,
            commands::github_git::set_repo_remote_protocol,
            commands::github_git::switch_github_cli_user,
            commands::github_git::logout_github_cli_user,
            commands::github_git::start_github_cli_login,
            ...
            commands::git_flow::git_flow,
            commands::workspace::list_branch_hygiene,
            commands::workspace::list_sync_commits,
            commands::workspace::preview_clean,
            commands::workspace::run_clean,
            commands::workspace::list_dangling_commits,
            commands::workspace::list_large_files,
            commands::workspace::set_file_flag,
            commands::workspace::list_file_flags,
            commands::workspace::format_patch,
            commands::workspace::apply_mailbox_patch,
            commands::workspace::sync_upstream,
            commands::workspace::list_commit_statuses,
            commands::workspace::get_blob_preview,
            ...
            commands::jira::list_branch_jira_links,
            commands::jira::link_branch_to_jira,
            commands::jira::unlink_branch_from_jira,
